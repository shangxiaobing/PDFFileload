...
@interface ThreeViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIScrollViewDelegate,collectionCellDelegate>//遵守协议
{
...
- (void)viewDidLoad {
    ...
    NSArray *arr = @[@"/Users/YXZT/Desktop/PDFFileload/PDFFileload/File/TestPage.pdf",@"http://teaching.csse.uwa.edu.au/units/CITS4401/practicals/James1_files/SPMP1.pdf"];
    
    _docRef = test(arr[1]);//通过test函数获取PDF文件资源，test函数的实现为我们最上面的方法，当然下面又写了一遍
